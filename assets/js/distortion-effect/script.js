document.addEventListener('DOMContentLoaded', () => {
	...
	if (distortionEffectSliders.length > 0) {
		distortionEffectSliders.forEach((slider) => {
			...
			const arraySlide = {};
			const arraySrcImage = []
			const arraySrcEffect = [
				'assets/images/distortion-effect/20.jpg',
				'assets/images/distortion-effect/21.jpg',
				'assets/images/distortion-effect/22.png'
			]
			...
			arraySrcImage.forEach((src, index) => {
				...
				arraySlide[key] = new hoverEffect({
					...
					image2: src,
					displacementImage: arraySrcEffect[1],
					hover: false,
				});
			});
